...
<!--       <div class="col-sm-4">
      ...
      <div class="col-sm-3">
        <h3 class="team-title">JEAN-JACQUES</h3>
        <h4 class="team-subtitle">Pragmatique, sociable, ouvert</h4>
        <p class='text-justify'>Etudiant en école de commerce et magicien autodidacte, Jean-Jacques porte une grande importance aux relations humaines.<br>
        Responsable commerciale et relation clients au sein de Kerden. il veille à ce que chaque utilisateur soit satisfait et trouve son bonheur au sein de l’expérience Kerden.
        </p>
      </div>       
    </div>
