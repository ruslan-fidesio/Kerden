...
.cocktail .locInfo .key{
	width: 60%;
	padding-left: 15px;
	display: inline-block;
}
.cocktail .locInfo .value{
	width: 40%;
	display: inline;
}

page[size^="A4"] .cocktail{
	font-size: 18px;
}
page[size="A5"] .cocktail{
	font-size: 12.5px;
}
page[size="A6"] .cocktail{
	font-size: 8.5px;
}
page[size='A4-4'] .cocktail{
    font-size: 8px;
}
page[size='A4-8'] .cocktail{
    font-size: 6px;
}
page[size='A4-16'] .cocktail{
    font-size: 4px;
}
...
<div class="cardBody cocktail">

		<div class="col-xs-6 col-xs-offset-1" style="margin-top:11%">
			<div class="row" >
