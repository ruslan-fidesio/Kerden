<div class="tabbable">
	<div class="col-xs-12 col-sm-9 col-sm-offset-3" style="z-index:2">
		<div class="text-center">Foire aux questions en tant que</div>
		<ul class="nav nav-pills row">
			<li class="text-center col-xs-12 col-sm-4 col-sm-offset-2 col-md-offset-2 active"><a href="#tabLoc" data-toggle='tab'>Locataire</a></li>
			<li class="text-center col-xs-12 col-sm-5 col-md-4"><a href="#tabPro" data-toggle="tab">Propriétaire</a></li>
		</ul>
		<hr style="width:70%">
	</div>
	...
	<div class="tab-content">
		<div class="tab-first-level tab-pane fade" id="tabPro">
			<div class="tabbable tabs-left row">
				<ul class="nav nav-pills-stacked col-sm-3 col-xs-12">
				...
				<div class="tab-content col-xs-12 col-sm-8 col-sm-offset-1">
					<div class="tab-pane active fade in" id='evnmts'>
						<ul>
							<li>
								<a href="#collapseQ111" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ112" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='paiement'>
						<ul>
							<li>
								<a href="#collapseQ121" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ122" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='prix'>
						<ul>
							<li>
								<a href="#collapseQ131" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='annulation'>
						<ul>
							<li>
								<a href="#collapseQ141" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ142" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ143" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='orga'>
						<ul>
							<li>
								<a href="#collapseQ151" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ152" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ153" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ154" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
		...
		<div class="tab-first-level tab-pane active fade in" id="tabLoc">
			<div class="tabbable tabs-left row">
				...
				<div class="tab-content col-xs-12 col-sm-8 col-sm-offset-1">
					<div class="tab-pane active fade in" id='locevnmts'>
						<ul>
							<li>
								<a href="#collapseQ11" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ12" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
									Comment les évènements sont-ils encadrés ? 
								</a>
...
De l’aide pourra être demandée pour le service mais la sécurité des lieux sera leur priorité
							...
							<li>
								<a href="#collapseQ13" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ14" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ15" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ16" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ17" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ18" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ19" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='locpaiement'>
						<ul>
							<li>
								<a href="#collapseQ21" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ22" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ23" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ24" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='locprix'>
						<ul>
							<li>
								<a href="#collapseQ31" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ32" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
					...
					<div class="tab-pane fade" id='locannulation'>
						<ul>
							<li>
								<a href="#collapseQ41" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
									Que se passe-t-il si j’annule plus de 72h avant le début de l’évènement ? 
								</a>
							...
							<li>
								<a href="#collapseQ42" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ2">
									Puis-je annuler le jour même ?
								</a>
							...
							<li>
								<a href="#collapseQ43" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ3">
							...
							<li>
								<a href="#collapseQ44" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ4">
					...
					<div class="tab-pane fade" id='locorga'>
						<ul>
							<li>
								<a href="#collapseQ51" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ52" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ53" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ54" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ55" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ56" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
							...
							<li>
								<a href="#collapseQ57" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseQ1">
