...
<div class="navbar navbar-kerden-home">
  <div class="row" style='width:100%;background-color: #a1fbbe;margin-left:0px'>
  <div class="navbar-brand" id="homeBrand">Espace membre</div>
  <!-- Collapsed Hamburger -->
...
@if( Auth::user() && count(Auth::user()->ownedGardens) > 0)
    <li class="dropdown"><a class="dropdown-toggle HPMenuLink messageMenu" href="#" data-toggle="dropdown">Messages
...
@else
    <li><a class="HPMenuLink messageMenu" href="/messages">Messages
      @if(Auth::user()->unreadMessages > 0)
          <sup class="unreadNumber">{{ Auth::user()->unreadMessages }}</sup>
      @endif
    </a></li>
