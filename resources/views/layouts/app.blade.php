...
<head>
    ...
    <!-- visor-caroussel -->
    <link rel="stylesheet" href="{{asset('css/jquery.visor-carousel.min.css')}}">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid" style='width:100%'>
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand navbar-brand-top" href="{{ url('/') }}"><div class="logo"></div>erden
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="rentCTA" 
                        @if(Auth::guest())
                            href="#" id="homepageGuestRentDropdown"
                        @else
                            @if(count(Auth::user()->ownedGardens)>0)
                                href="{{url('/garden/update/'. Auth::user()->ownedGardens[0]->id )}}" 
                            @else
                                href="#" id="homepageRentDropdown"
                            @endif
                        @endif
                    >{{trans('base.rent')}}</a>
                        <div class="mySelect" id='homepageRentSelect'>
                            <ul>
                                <li data-myvalue="Le jardin"><a href="{{url('/garden/create?cat=Le jardin')}}">Jardin</a></li>
                                <li data-myvalue="La terrasse"><a href="{{url('/garden/create?cat=La terrasse')}}">Terrasse</a></li>
                                <li data-myvalue="Le domaine"><a href="{{url('/garden/create?cat=Le domaine')}}">Domaine</a></li>
                                <li data-myvalue="Le jardin d'hiver"><a href="{{url('/garden/create?cat=Le jardin d\'hiver')}}">Jardin d'hiver</a></li>
                                <li data-myvalue="Le jardin restaurant"><a href="{{url('/garden/create?cat=Le jardin restaurant')}}">Jardin restaurant</a></li>
                                <li data-myvalue="Le château"><a href="{{url('/garden/create?cat=Le château')}}">Château</a></li>
                            </ul>
                        </div>
                        <div class="mySelect" id='homepageGuestRentSelect'>
                            <ul>
                                <li data-myvalue="Le jardin"><a href="{{url('/rent?cat=Jardin')}}">Jardin</a></li>
                                <li data-myvalue="La terrasse"><a href="{{url('/rent?cat=Terrasse')}}">Terrasse</a></li>
                                <li data-myvalue="Le domaine"><a href="{{url('/rent?cat=Domaine')}}">Domaine</a></li>
                                <li data-myvalue="Le jardin d'hiver"><a href="{{url('/rent?cat=Jardin d\'hiver')}}">Jardin d'hiver</a></li>
                                <li data-myvalue="Le jardin restaurant"><a href="{{url('/rent?cat=Jardin restaurant')}}">Jardin restaurant</a></li>
                                <li data-myvalue="Le château"><a href="{{url('/rent?cat=château')}}">Château</a></li>
                            </ul>
                        </div>
                    </li>
                    @if (Auth::guest())
                        <li><a href="#" data-toggle="modal" data-target="#inscriptionModal">{{trans('auth.register')}}</a></li>
                        <li><a href="#" data-toggle="modal" data-target="#connexionModal">{{trans('auth.login')}}</a></li>
                    @else
                        <li class="dropdown">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    ...
                    <form class="form-horizontal row" role="form" method="POST" action="{{ url('/login') }}" id='mainLoginForm'>
                        {!! csrf_field() !!}

                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label class="col-xs-12 col-md-6 col-md-offset-3 col-sm-offset-2 text-left">Adresse E-Mail</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label class="col-xs-12 col-md-6 col-md-offset-3 col-sm-offset-2 text-left">Mot de passe</label>
                        ...
                        <div class="form-group">
                            <div class="col-xs-5 col-sm-6 text-right">
                                <button type="submit" class="btn btn-kerden-valid">
                                    <i class="fa fa-btn fa-sign-in" style='color:#98ecb1'></i>&nbsp;Connexion
                                </button>
                            </div>
                            <div class="col-xs-6">

                                <a class="btn btn-link" style='color:black' href="{{ url('/password/reset') }}">Mot de passe oublié?</a>
                            </div>
                        </div>
                    </form>
                    <hr/>
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <a href="#" id="switchModal">
                                <div class="btn btn-kerden">Inscrivez vous</div>
                            </a>
                        </div>
                    </div>
      </div>
